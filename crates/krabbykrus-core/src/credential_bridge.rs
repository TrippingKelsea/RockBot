...
//! `krabbykrus_tools::CredentialAccessor` and bridges tool credential
//! requests to the `krabbykrus_credentials::CredentialManager`.

use krabbykrus_credentials::{CredentialManager, PermissionLevel};
use krabbykrus_tools::{CredentialAccessor, CredentialApplicationType, CredentialResult, Result, ToolError};
use std::sync::Arc;
