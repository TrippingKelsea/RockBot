...
//!
//! This module provides a Discord bot integration for Krabbykrus agents.
//!
//! # Configuration
//!
...
//!
//! ```no_run
//! use krabbykrus_channels::discord::DiscordChannel;
//!
//! let channel = DiscordChannel::new("my-bot-token").await?;
...
impl Channel for DiscordChannel {
    ...
    async fn connect(&mut self) -> Result<()> {
        ...
        // Store HTTP client for API calls
    ...
    async fn edit_message(&self, message_id: &str, new_content: &str) -> Result<()> {
        // Message ID format: "channel_id:message_id"
