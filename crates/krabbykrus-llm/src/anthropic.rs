...
//! ## Usage
//! ```ignore
//! use krabbykrus_llm::anthropic::AnthropicProvider;
//!
...
use crate::{
    ...
    LlmProvider, Message, MessageRole, ModelInfo, ProviderCapabilities, Result,
    StreamingChunk, StreamingChoice, StreamingDelta, Usage,
};
